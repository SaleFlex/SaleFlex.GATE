...
| 8 | [08-public-web-portal-landing-and-accounts.md](08-public-web-portal-landing-and-accounts.md) | Public landing, register, login, logout, password change (`web_ui_app`); static CSS, icons, JS layout |
