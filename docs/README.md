...
| 10 | [10-shared-models-package.md](10-shared-models-package.md) | Legacy `web_ui_app.models` shim notes; current model ownership is in `core.models` |
| 11 | [11-gate-user-model.md](11-gate-user-model.md) | `Cashier` (`AUTH_USER_MODEL`), `CompanyMembership` (per-company roles), and `CashierStoreAssignment` |
| 12 | [12-core-app.md](12-core-app.md) | `core` app — centralised model layer, `BaseModel` audit fields, import conventions, adding new models |
