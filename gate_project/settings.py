...
"""
Django settings for gate_project project.
...
SECRET_KEY = 'django-insecure-6zmum!_!=mx7vo_7bbw6c3rm=zqcv_6w8jlm^=xok_@2p_a@k='
...
ROOT_URLCONF = 'gate_project.urls'
...
# Browser sessions (web_ui_app landing, registration, login)
